...
function compress(config, callback) {
    return __awaiter(this, void 0, void 0, function () {
        var data, filename, writers, output, version, license, splitLines, licenseFile, licenseData, lines, regex, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    globals.initialize(config);
                    data = config.fileContent, filename = config.filename, writers = globals.writers, output = globals.output, version = globals.config.version, license = globals.config.license;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    splitLines = data.split(/\r\n|\n/);
                    splitLines[0] = splitLines[0].trim();
                    return [4 /*yield*/, buildContents(splitLines, filename)];
                case 2:
                    _a.sent();
                    // generate the output
                    generateOutput();
