...
function compress(config, callback) {
    ...
    var data = config.fileContent, filename = config.filename, writers = globals.writers, output = globals.output, version = globals.config.version, license = globals.config.license;
