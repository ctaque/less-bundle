...
function buildContents(lines, filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var writers, imports, lessRegex, cssRegex, stringLiteralRegex, currentLines, line, hashPath, imported, file, splitLines, index, deTildedImport, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(index < lines.length)) return [3 /*break*/, 8];
                    line = lines[index].trim();
                    if (!(line.indexOf('@import ') === 0)) return [3 /*break*/, 6];
                    ...
                    if (!(typeof imports[hashPath] === 'undefined')) return [3 /*break*/, 5];
